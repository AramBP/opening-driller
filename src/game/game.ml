...
module State = struct
  ...
  let make_move move gs = 
    let eq = Tile.Coord.equal in
    let ents, prev_move, curr_color = gs.ents, gs.prev_move, gs.curr_color in

    let move_ent src dest ent ents =
      let ents = List.Assoc.remove ents src ~equal:eq in
      let ents = List.Assoc.add ents dest { ent with has_moved = true } ~equal:eq in
  ...
  let init = 
    let ents = [
      (Tile.{ x = 0 ; y = 0 }, { kind = Rook ; color = Color.White ; has_moved = false }) ; 
      (Tile.{ x = 7 ; y = 0 }, { kind = Rook ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 1 ; y = 0 }, { kind = Knight ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 6 ; y = 0 }, { kind = Knight ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 2 ; y = 0 }, { kind = Bishop ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 5 ; y = 0 }, { kind = Bishop ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 3 ; y = 0 }, { kind = Queen ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 4 ; y = 0 }, { kind = King ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 0 ; y = 7 }, { kind = Rook ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 7 ; y = 7 }, { kind = Rook ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 1 ; y = 7 }, { kind = Knight ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 6 ; y = 7 }, { kind = Knight ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 2 ; y = 7 }, { kind = Bishop ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 5 ; y = 7 }, { kind = Bishop ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 3 ; y = 7 }, { kind = Queen ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 4 ; y = 7 }, { kind = King ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 0 ; y = 1 }, { kind = Pawn ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 7 ; y = 1 }, { kind = Pawn ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 1 ; y = 1 }, { kind = Pawn ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 6 ; y = 1 }, { kind = Pawn ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 2 ; y = 1 }, { kind = Pawn ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 5 ; y = 1 }, { kind = Pawn ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 3 ; y = 1 }, { kind = Pawn ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 4 ; y = 1 }, { kind = Pawn ; color = Color.White ; has_moved = false }) ;
      (Tile.{ x = 0 ; y = 6 }, { kind = Pawn ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 7 ; y = 6 }, { kind = Pawn ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 1 ; y = 6 }, { kind = Pawn ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 6 ; y = 6 }, { kind = Pawn ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 2 ; y = 6 }, { kind = Pawn ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 5 ; y = 6 }, { kind = Pawn ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 3 ; y = 6 }, { kind = Pawn ; color = Color.Black ; has_moved = false }) ;
      (Tile.{ x = 4 ; y = 6 }, { kind = Pawn ; color = Color.Black ; has_moved = false })      
    ]
    in
